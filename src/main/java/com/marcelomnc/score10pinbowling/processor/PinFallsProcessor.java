        ...
        games.forEach((gameOwner, gameDTO) -> {
                ...
                if (currentFrameIndex == 9) {
                    ...
                    if (playerChanceDTO.getKnockedDownPins() == 10) {
                        ...
                        if (currentPinFallIndex == 0
                            ...
                            gameDTO.setValid(false);
                            LOGGER.log(Level.SEVERE, "Game for player: " + gameDTO.getPlayerName() + " invalidated, frame: " + (currentFrameIndex + 1) + " exceeds pinFalls max sum of 10");
                            break;
                        }
                    } else {
                        if (currentPinFallIndex == 0) {
            ...
            if (gameDTO.isValid()) {
                if (gameDTO.getFrameDTOS().size() < 10) {
                    ...
                    gameDTO.setValid(false);
                    LOGGER.log(Level.SEVERE, "Game for player: " + gameDTO.getPlayerName() + " invalidated, it has not enough chances data");
                }
            }
        });
    }

...
public class SimplePlayerChancesFileLineValidator implements PlayerChancesFileLineValidator {
    private static final Logger LOGGER = Logger.getLogger(SimplePlayerChancesFileLineValidator.class.getName());
